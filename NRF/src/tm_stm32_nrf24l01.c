...
void inline NRF24L01_FLUSH_TX(SPI_TypeDef* SPIx)
{
    NRF24L01_CSN_LOW;
    TM_SPI_Send(SPIx, NRF24L01_FLUSH_TX_MASK);
    NRF24L01_CSN_HIGH;
}

void NRF24L01_FLUSH_RX(SPI_TypeDef* SPIx)
{
    NRF24L01_CSN_LOW;
    TM_SPI_Send(SPIx, NRF24L01_FLUSH_RX_MASK);
    NRF24L01_CSN_HIGH;
}
...
void TM_NRF24L01_InitPins(void) {
    ...
    GPIO_InitStructure.GPIO_Pin = NRF24L01_CSN_PIN | NRF24L01_CE_PIN;
...
uint8_t TM_NRF24L01_ReadRegister(uint8_t reg) {
	uint8_t value;
	NRF24L01_CSN_LOW;
	value = TM_SPI_Send(NRF24L01_SPI, NRF24L01_READ_REGISTER_MASK(reg));
