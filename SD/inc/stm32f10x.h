...
#define  RCC_APB1RSTR_PWRRST                 ((uint32_t)0x10000000)        /*!< Power interface reset */
 ...
 #define  RCC_APB1RSTR_DSD_SPIST                 ((uint32_t)0x20000000)        /*!< DAC interface reset */
#endif
...
#define  RCC_APB1ENR_PWREN                   ((uint32_t)0x10000000)        /*!< Power interface clock enable */
 ...
 #defineSD_SPICC_APB1ENR_DACEN                  ((uint32_t)0x20000000)        /*!< DAC interface clock enable */
#endif
